...
public:
    ...
    PlatformWithEquation(const sf::Texture &arg_texture, sf::RenderWindow *arg_okno,
        ...
        ScoreTable(arg_okno,arg_texture,arg_rect,arg_back_position,arg_text_position,start_string,character_size),
